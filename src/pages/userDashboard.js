...
import './userDashboard.css'; // Importando o CSS
                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul className="navbar-nav ms-auto">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" href="donation.html">Doar</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="orderEquipment.html">Solicitar</a>
                            </li>
                            <li className="nav-item">
                    ...
                    <div className="col-md-6">
                        <div className="dashboard-card p-4 text-light">
                            ...
                            <div className="d-grid gap-3">
                                ...
                                <button onClick={orderEquipment} className="btn btn-info btn-lg">
